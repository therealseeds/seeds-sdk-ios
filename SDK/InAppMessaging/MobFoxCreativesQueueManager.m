...
//
//  Changes: removed support of all Creative types except Banner;
//
...
-(void) initQueuesWithFallbackData {
    ...
    self.queueForBanner = [NSArray arrayWithObjects:bannerCreative, nil];
    self.queueForFullscreen = [NSArray arrayWithObjects:bannerCreative, nil];
}
